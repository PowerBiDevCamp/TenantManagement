...
* [Set up your development environment](https://github.com/PowerBiDevCamp/TenantManagement#set-up-your-development-environment)
  ...
  * [Configure Power BI tenant-level settings for service principal access](https://github.com/PowerBiDevCamp/TenantManagement#configure-power-bi-tenant-level-settings-for-service-principal-access)
  * [Create the Azure AD Application for the **TenantManagement** Application](https://github.com/PowerBiDevCamp/TenantManagement#create-the-azure-ad-application-for-the-tenantmanagement-application)
* [Test the Tenant Management project in Visual Studio 2019](https://github.com/PowerBiDevCamp/TenantManagement#test-the-tenant-management-project-in-visual-studio-2019)
  * [Download the Source Code](https://github.com/PowerBiDevCamp/TenantManagement#download-the-source-code)
  * [Open the Project in Visual Studio 2019](https://github.com/PowerBiDevCamp/TenantManagement#open-the-project-in-visual-studio-2019)
  * [Update application settings in the **appsettings.json** file](https://github.com/PowerBiDevCamp/TenantManagement#update-application-settings-in-the-appsettingsjson-file)
  * [Create the **TenantManagementDB** database](https://github.com/PowerBiDevCamp/TenantManagement#create-the-tenantmanagementdb-database)
* [Test the **Tenant Management** Application](https://github.com/PowerBiDevCamp/TenantManagement#test-the-tenant-management-application)
  * [Create App Identities](https://github.com/PowerBiDevCamp/TenantManagement#create-app-identities)
  * [Create New Power BI Tenants](https://github.com/PowerBiDevCamp/TenantManagement#create-new-power-bi-tenants)
  * [Embed Reports](https://github.com/PowerBiDevCamp/TenantManagement#embed-reports)
  * [Inspect the Power BI Workspaces](https://github.com/PowerBiDevCamp/TenantManagement#inspect-the-power-bi-workspaces)
  * [Create a Separate Service Principal for Each Tenant](https://github.com/PowerBiDevCamp/TenantManagement#create-a-separate-service-principal-for-each-tenant)
